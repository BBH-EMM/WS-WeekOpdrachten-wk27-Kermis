...
public class Attr_LadderKlimmen extends Attractie {
	public Attr_LadderKlimmen(String naamAttractie, int minStroomVerbruik, int maxStroomVerbruik, double attractiePrijsVolwassenen, double attractiePrijsKinderen, boolean IsKinderAttractie) {
...
//
//	public Attr_LadderKlimmen (String naamAttractie) {
